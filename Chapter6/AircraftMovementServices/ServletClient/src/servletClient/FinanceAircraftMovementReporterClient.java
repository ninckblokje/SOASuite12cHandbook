...
import saibot.airport.finance.AircraftMovement;
import saibot.airport.finance.FinanceAircraftMovementReporter;
...
public class FinanceAircraftMovementReporterClient {
    public static void main(String[] args) {
        try {
            ...
            movement.setFlightNumber(1);
            
            financeAircraftMovementReporter.reportAircraftMovemementReporter(movement);
